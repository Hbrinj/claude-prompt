...
7. **Retire `grill-plan` + dispatch + `prompt-master`** — delete `grill-plan.md`, `parallel-dispatch.md`, `parallel-docker-dispatch.md`, `docker/`, the dispatch scripts, and `skills/prompt-master/` (user directive 2026-06-12: remove prompt-master completely); scrub their rows/references everywhere (`skills/README.md`, `agents/README.md`, `prompt-definition-reviewer.md`'s complementary-skill mention, `README.md`'s dispatch section). All README-row scrubbing for these happens here in PR-B, not PR-A.
   - Files: `skills/grill-plan.md`, `skills/parallel-dispatch.md`, `skills/parallel-docker-dispatch.md`, `skills/prompt-master/`, `agents/architecture.md`, `docker/`, dispatch scripts (DELETE); `skills/README.md`, `agents/README.md`, `README.md`, `agents/prompt-definition-reviewer.md` (UPDATE) — Acceptance: no dangling `grill-plan`/`dispatch`/`prompt-master`/`architecture` references (repo-wide sweep clean).
